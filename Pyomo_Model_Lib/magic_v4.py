...
# Parameters
# Demand (1000mw) #change 3pm-6pm to 50
dem_init = {'12pm-6am': 15, '6am-9am': 30, '9am-3pm': 25, '3pm-6pm': 50, '6pm-12pm': 27}
...
# Generation data #change number of type-3 to 3
gen_data = {
    ...
    'type-3': {'min-pow': 1.5, 'max-pow': 4.0, 'cost-min': 3000, 'cost-inc': 3.0, 'start': 500, 'number': 3}
}
