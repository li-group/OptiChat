...
# Generation data #change the max-pow of type-1 to 1.0 change the min-pow and max-pow of type-2 to 0.25 and 0.5
gen_data = {
    'type-1': {'min-pow': 0.85, 'max-pow': 1.0, 'cost-min': 1000, 'cost-inc': 2.0, 'start': 2000, 'number': 12},
    'type-2': {'min-pow': 0.25, 'max-pow': 0.5, 'cost-min': 2600, 'cost-inc': 1.3, 'start': 1000, 'number': 10},
