...
qs_values = {('lower', 'premium', 'octane'): 100, #change the premium octane lower bound to 100
             ('lower', 'regular', 'octane'): 86,
             ('upper', 'premium', 'vapor-pr'): 11,
             ('upper', 'regular', 'vapor-pr'): 12.7,
             ('upper', 'distillate', 'density'): 306,
             ('upper', 'distillate', 'sulfur'): 0.5,
             ('upper', 'fuel-oil', 'density'): 352,
             ('upper', 'fuel-oil', 'sulfur'): 3.5} #change the premium vapor-pr upper bound to 11, 
...
model.d = Param(model.cf, mutable=True, initialize={'premium':40, 'regular':0, 'distillate':0, 'fuel-oil':36, 'fuel-gas':7.5})
