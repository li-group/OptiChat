...
RTN.Xmax = pe.Param(RTN.R, mutable=True, initialize = {r: net.nodes[r]["Xmax"] / 2 for r in RTN.R}) #Xmax (maximum resource inventory)
RTN.Xmin = pe.Param(RTN.R, mutable=True, initialize = {r: net.nodes[r]["Xmin"] / 2 for r in RTN.R}) #Xmin (minimum resource inventory)
