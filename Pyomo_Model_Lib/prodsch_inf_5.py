...
model.dpcmax = Param(initialize=800, mutable = True, doc='direct production cost max limit')
...
model.dpcup = Constraint(model.q,rule=lambda model, q: model.dpc[q] <= model.dpcmax)
