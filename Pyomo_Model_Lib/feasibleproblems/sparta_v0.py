...
# Parameters
model.infl = Param(model.t, initialize={1: 1.00, 2: 1.05, 3: 1.12, 4: 1.71, 5: 1.80,
                                        6: 1.90, 7: 1.97, 8: 2.10, 9: 2.22, 10: 2.38},
                   doc='inflation index')
model.req = Param(model.t, initialize={1: 5, 2: 6, 3: 7, 4: 6, 5: 4,
                                       6: 9, 7: 8, 8: 8, 9: 6, 10: 4},
                  doc='troop requirement')
model.clen = Param(model.l, initialize={1: 50, 2: 85, 3: 115, 4: 143},
                   doc='cost of service')
...
model.cost = Objective(expr=model.z, doc='cost definition')
