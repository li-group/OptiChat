...
model.iscmax = Param(initialize=10, mutable = True, doc='inventory storage cost max limit')
...
model.iscup = Constraint(model.q,rule=lambda model, q: model.isc[q] <= model.iscmax)
