...
RTN.Vmax = pe.Param(RTN.I, mutable=True, initialize = {i: net.nodes[i]["Vmax"] / 4 for i in RTN.I}) #Vmax (max batch size)
RTN.Vmin = pe.Param(RTN.I, mutable=True, initialize = {i: net.nodes[i]["Vmin"] / 4 for i in RTN.I}) #Vmin (min batch size)
