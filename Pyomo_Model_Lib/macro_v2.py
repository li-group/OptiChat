...
qs_values = {('lower', 'premium', 'octane'): 90,
             ...
             ('upper', 'fuel-oil', 'sulfur'): 3.2} #change the fuel-oil sulfur concentration to 3.2
...
model.d = Param(model.cf, mutable=True, initialize={'premium':40, 'regular':0, 'distillate':0, 'fuel-oil':36, 'fuel-gas':7.5}, doc='demand')
