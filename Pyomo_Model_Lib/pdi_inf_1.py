...
model.pfd = Param(model.p, model.pf, initialize ={
    ('one', 'max-prod'):  1150,  ('one', 'over-prod'): 1000, ('one', 'prod-cost'): 35, ('one', 'over-cost'): 45,
    ('two', 'min-prod'):  1200,  ('two', 'max-prod'):  3000, ('two', 'over-prod'): 500,  ('two', 'prod-cost'): 40, ('two', 'over-cost'): 43,
    ('three', 'min-prod'):  700, ('three', 'max-prod'):  1500, ('three', 'prod-cost'): 38}, 
    default = 0, mutable = True, doc='production facility data ')
