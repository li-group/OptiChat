...
# with open("sparta_inf_1_data.json", "r") as file:
#     data = json.load(file)
...
model.man_avail = Param(model.t, default=5, mutable=True, initialize={int(k): v for k, v in data["parameters"]["manpower_available"].items()}, doc='manpower available each year')
