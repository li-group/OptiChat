...
# Parameters
model.b = Param(model.n, initialize={'calorie': 0.6, 'protein': 70, 'calcium': 0.8, 'iron': 12, 'vitamin-a': 5, 'vitamin-b1': 1.8, 'vitamin-b2': 2.7, 'niacin': 18, 'vitamin-c': 75}, mutable = True, doc='required daily allowances of nutrients')
